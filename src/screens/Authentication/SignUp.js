      ...
      axios
        ...
        .catch((error) => {
          if (error.response) {
            ...
            window.alert(
              "There is some internal error. Please check your network connection or try again later."
            );
        });
    }
  };
      ...
      <div className="signup-container">
        ...
        <form className="signup-form" onSubmit={handleFormSubmit}>
          ...
          {errorMessages.username && (
            <SubLine size="14px">{errorMessages.username}</SubLine>
          )}
          ...
          />
          {errorMessages.email && (
            <SubLine size="14px">{errorMessages.email}</SubLine>
          )}
          ...
          {errorMessages.password2 && (
            <SubLine size="14px">{errorMessages.password2}</SubLine>
          )}
          ...
          <button className="signup-button" type="submit">
            <p className="signup-button-text">Sign Up</p>
          </button>
        </form>
        {status === 201 && (
          <SubLine style={{ marginTop: "10px" }}>
            Account has been registered. Please confirm your email and proceed
            to sign in.
          </SubLine>
        )}
        <div>
          <p className="footer-text">
            ...
            <a className="footer-text-link" href={"/signin"}>
              {" "}
              Sign In
            </a>
          </p>
