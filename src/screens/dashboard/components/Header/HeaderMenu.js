        ...
        <div className="menu-container">
            ...
            <div className="notification-sign-container" onClick={notifToggle}>
                <svg width="10" height="12" viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M5 0C3.92954 0 2.98173 0.691642 2.65518 1.71108L0 10H10L7.34482 1.71108C7.01827 0.691641 6.07046 0 5 0ZM3.5 11C3.22386 11 3 11.2239 3 11.5C3 11.7761 3.22386 12 3.5 12H6.5C6.77614 12 7 11.7761 7 11.5C7 11.2239 6.77614 11 6.5 11H3.5Z" fill="white" />
                </svg>
            ...
            <div className="Notification">
                            ...
                            <div className="menu2">
                                <ul>
                                <li><img src="profile.png"></img><a href="#"> Your order ID#1201 is pending </a></li>
                                <li><img src="orders.png"></img><a href="#"> Your order ID#1201 is placed</a></li>
                                <li><img src="settings.png"></img><a href="#"> Settings </a></li>
                                <li><img src="help.png"></img><a href="#">Help </a></li>
                                <li><img src="signout.png"></img><a href="#"> Signout </a></li>
                                </ul>
                            </div>
                </div>
            ...
            <div className="action">
                            <div className="menu">
                                <h3>Username
                                <br></br>
                                <span>Balance: 24,539$</span></h3>
                                <ul>
                                <li><img src="profile.png"></img><a href="#"> Profile </a></li>
                                <li><img src="orders.png"></img><a href="#"> Your Orders </a></li>
                                <li><img src="settings.png"></img><Link to={"/accountsettings"}> Settings </Link></li>
                                <li><img src="help.png"></img><a href="#">Help </a></li>
                                <li><img src="signout.png"></img><a href="#"> Signout </a></li>
                                </ul>
                            </div>
