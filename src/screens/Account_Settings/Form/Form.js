...
class Form extends Component {
  ...
  render() {
    ...
    return (
      ...
      <nav>
        <form onSubmit={this.handleSubmit}>
          ...
          <TextField  className="text-field-ac" 
                        id="forminp" 
            type="text"
    ...
    styles={customStyles2}
          ...
          <Select id="sel2" onChange={this.handleCountry} defaultValue="Select Country" value={selectedOption2} options={optionsCountry}
               theme={theme => ({
      ...theme,
      borderRadius: 5,
    })}
    styles={customStyles1}
          />
            {/* <option id="formcol" className="option" defaultValue>Select Country</option>
           { value:'Afganistan' , label: 'Afghanistan'},
           { value:'Albania' , label: 'Albania'},
           { value:'Algeria' , label: 'Algeria'},
           { value:'American Samoa' , label: 'American Samoa'},
        ...
        <article>
        <img className="face_image" src="profile.jpg" alt="avatar" />
      
        <h1 className="change_picture_heading">Change Profile Pic</h1>
          
                {/* <input id="profilepic" type="file" onChange={this.onFileChange} /> */}
                {/* <button className="change_picture_heading" onClick={this.onFileUpload}>
                Change Profile Pic
                </button> */}
